...
def test_resolve_display_version_prefers_prerelease_branch_version():
    assert resolve_display_version("1.0.8-pre-release", "pre-release/1.0.9") == "1.0.9-pre-release"


def test_resolve_display_version_fallbacks_to_base_version():
    assert resolve_display_version("1.0.9-pre-release", "feature/new-ui") == "1.0.9-pre-release"
