...
def build_settings_payload(settings: Any) -> dict[str, object]:
    ...
    return {
        ...
        "active_directory_dns_servers": str(getattr(settings, "active_directory_dns_servers", "") or "").strip(),
        ...
        "active_directory_sync_technical_accounts": bool(getattr(settings, "active_directory_sync_technical_accounts", True)),
        "active_directory_technical_accounts_ou_dn": str(getattr(settings, "active_directory_technical_accounts_ou_dn", "") or "").strip(),
        "active_directory_technical_accounts_filter": str(getattr(settings, "active_directory_technical_accounts_filter", "") or "").strip() or "(&(objectCategory=person)(objectClass=user))",
        "active_directory_primary_last_sync_at": str(getattr(settings, "active_directory_primary_last_sync_at", "") or "").strip(),
        "active_directory_sources_json": str(getattr(settings, "active_directory_sources_json", "[]") or "[]"),
...
def build_notification_settings_kwargs(data: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "active_directory_dns_servers": str(data.get("active_directory_dns_servers", "") or "").strip(),
        ...
        "active_directory_sync_technical_accounts": bool(data.get("active_directory_sync_technical_accounts", True)),
        "active_directory_technical_accounts_ou_dn": str(data.get("active_directory_technical_accounts_ou_dn", "OU=Comptes de service,OU=Informatique") or "").strip(),
        "active_directory_technical_accounts_filter": str(data.get("active_directory_technical_accounts_filter", "") or "").strip() or "(&(objectCategory=person)(objectClass=user))",
        "active_directory_primary_last_sync_at": str(data.get("active_directory_primary_last_sync_at", "") or "").strip(),
        "active_directory_sources_json": str(data.get("active_directory_sources_json", "[]") or "[]"),
